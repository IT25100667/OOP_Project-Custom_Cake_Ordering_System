...
<head>
    ...
    <title>Design Your Custom Cake | FAB Cakes</title>
...
<body>
    ...
    <!-- Fixed Navbar (Copied structure from index.jsp) -->
    <nav class="navbar">
        <div class="container nav-container">
            <a href="/home" class="nav-logo">FAB Cakes.</a>
            ...
            <ul class="nav-links">
                ...
                <li><a href="/products/custom-cakes" class="nav-link active">Custom Cakes</a></li>
        ...
        <div class="custom-builder-layout">
            ...
            <div>
                <div class="summary-panel">
                    ...
                    <button id="btn-add-custom" class="btn btn-primary" style="width: 100%; margin-top: 1.5rem; justify-content: center; font-size: 1.1rem; padding: 1rem;" disabled>
